...
|---|---|---|---|
| CPU reference workload<br><sub>best of 3; 0.97x this machine's median over 4 earlier runs</sub> | `0.3763 s` | `inf s` | PASS |

**Markovian lift**

| check | measured | threshold | verdict |
|---|---|---|---|
| rough objective evaluation, 10 expiries x 13 strikes<br><sub>best of 3 (all: 0.80, 0.80, 0.79); trend target: rolling mean <= 0.75 s</sub> | `0.7904 s` | `3 s` | PASS |
...
| startup to actionable error, no TWS<br><sub>was 9.6 s before lazy imports</sub> | `0.7738 s` | `3 s` | PASS |
| calibration objective evaluation<br><sub>39 quotes; 470 ms before vectorising</sub> | `14.45 ms` | `200 ms` | PASS |
...
Trend over 14 recorded run(s); compared within this machine and configuration (LAPTOP-1VCRA7FA, lift 40:1e+08)
--------------------------------------------------------------------------
  check                                            n       mean        std       last  flags
  2025 reference split: session / overnight / we   5          0          0          0  
  3-point stencil order on the same grid (kept f   5      1.086          0      1.086  
  7-day IV, default lift vs true rough Heston (f   5    0.02961          0    0.02961  
  95% interval coverage, 20 chains with 2% noise   5       0.95          0       0.95  
  CPU reference workload                           5     0.3605    0.07011     0.3763  
  Carr-Madan insensitive to damping alpha          5   6.11e-16          0   6.11e-16  
  Carr-Madan vs exact Black-76                     5   1.94e-16          0   1.94e-16  
  ETDRK4 vs implicit trapezoidal + Richardson (H   5   4.12e-06          0   4.12e-06  
  Fourier vs Monte Carlo (sigmas)                  5     0.3618          0     0.3618  
  Gauss-Legendre rules constructed                 5          1          0          1  
  H from ATM skew (planted 0.12)                   5       0.12   1.55e-17       0.12  
  H from structure function, worst of 4 planted    5     0.0062          0     0.0062  
  Heston: property switches on at alpha = kappa    5   1.38e-06          0   1.38e-06  
  Ito isometry of the lift at 1 day, shortfall v   5      5.058          0      5.058  
  Jacobian condition number at the solution        5      30.05          0      30.05  
  K(t) = int e^-xt mu(dx) representation           5   6.67e-10          0   6.67e-10  
  Labor Day weekend: Friday close to Tuesday ope   5       89.5          0       89.5  
  Laplace-domain error on the pricing band z in    5   0.006354          0   0.006354  
  Laplace-domain error, z in [0.1, 100] (plan: 1   5    0.03349          0    0.03349  
  Lewis vs Carr-Madan on Heston                    5   4.99e-15          0   4.99e-15  
  Lewis vs exact Black-76                          5   3.55e-15          0   3.55e-15  
  MLE plant-and-recover, worst |z|                 5      1.004          0      1.004  
  N=1 at x=0 reproduces closed-form Heston (ETDR   5   7.09e-10          0   7.09e-10  
  NYSE 2026 holidays by rule vs the published ca   5          0          0          0  
  QE step: mean vs exact conditional mean, in SE   5   0.009151          0   0.009151  
  RMSE improvement minus steady-state theory       5     0.3392          0     0.3392  
  SE(H), 20 quotes, equal weights, 0.5 vp noise    5    0.04652          0    0.04652  
  SE(H), same quotes, vega^2 weights               5     0.1967          0     0.1967  
  SE(H): inverse variance / vega^2                 5     0.1018          0     0.1018  
  SVI parameter recovery                           5   1.43e-08          0   1.43e-08  
  SVI slice passes Durrleman                       5          1          0          1  
  US close in UTC follows daylight saving          5          1          0          1  
  adaptive: bad-print excursion (x normal error)   5      14.92          0      14.92  
  away from zero, 400 days: both filters' log-li   5       1.91          0       1.91  
  branch continuity, shipped (max/median step)     5      5.242          0      5.242  
  branch discontinuity, reciprocal form            5       2825          0       2825  
  butterfly audit: catches a planted dent          5          2          0          2  
  butterfly audit: false positives on a convex s   5          0          0          0  
  calendar audit: catches a reversal               5          3          0          3  
  calendar audit: clean on monotone w              5          0          0          0  
  calibration objective evaluation                 5      13.67      2.714      14.45  
  corr(H, xi) at the truth                         5     0.9777          0     0.9777  
  count variance / Hawkes (1971) closed form, 0.   5      1.019          0      1.019  
  delayed greeks (tick 83) recorded, vega per 1.   5          1          0          1  
  density non-negativity (min/peak)                5  -8.87e-10          0  -8.87e-10  
  discount factor from parity                      5   4.44e-16          0   4.44e-16  
  dual vs joint EKF agreement                      5      0.129          0      0.129  
  exact-moment filter: QML kappa bias away from    5      1.056          0      1.056  
  exptrap at 120 steps, u to 1200, guards off (N   5   1.08e+36          0   1.08e+36  
  fast scalar path vs generic matrix filter        5          0          0          0  
  fd_first exact on a quadratic                    5   7.46e-14          0   7.46e-14  
  fd_second on a quadratic vs its rounding floor   5       0.41   6.21e-17       0.41  
  filter profile likelihood: |H_hat - 0.12| in S   5     0.4698   6.21e-17     0.4698  
  fitted RMSE on clean data                        5   4.06e-09          0   4.06e-09  
  forward from put-call parity                     5   1.14e-13          0   1.14e-13  
  full N-node lift at H = 0.4999 vs Heston         5   1.65e-05          0   1.65e-05  
  implied-vol round trip                           5   8.05e-16          0   8.05e-16  
  kernel error of the default lift, t in [1 day,   5   0.007027          0   0.007027  
  kernel error of the default lift, worst over H   5   0.009075          0   0.009075  
  kernel error of the default lift, worst over H   5   0.009075          0   0.009075  
  kernel error on [1 hour, 2 y]                    5   0.007027          0   0.007027  
  kernel error on [5 minutes, 2 y]                 5   0.007027          0   0.007027  
  kurtosis vs scale-mixture closed form, in SE     5     0.7597          0     0.7597  
  lecture AR(1) kappa on noisy quotes / true kap   5       12.6          0       12.6  
  lifted path vs true-kernel Volterra path (L2,    5   0.006333          0   0.006333  
  lifted recursion == SOE convolution (identity)   5   3.39e-14          0   3.39e-14  
  lifted rough filter: RMSE improvement over quo   5      37.67          0      37.67  
  log-likelihood of H = 0.49 against the best H    5     -329.7          0     -329.7  
  mean rate vs mu/(1-n), in SE                     5     0.5936          0     0.5936  
  min |corr(H, xi)| over all schemes and designs   5     0.9219          0     0.9219  
  naive-form cancellation at xi=1e-6 (kept to pr   5   3.44e-05          0   3.44e-05  
  near zero (V = 0 on 14% of days): particle log   5       68.4          0       68.4  
  near zero: CF filter vs particle filter log-li   5      1.174          0      1.174  
  norm_cdf vs scipy                                5   2.22e-16          0   2.22e-16  
  norm_pdf vs scipy                                5          0          0          0  
  phi(-i) = 1 (martingale)                         5          0          0          0  
  phi(-u) = conj(phi(u))                           5          0          0          0  
  phi(0) = 1                                       5          0          0          0  
  plant-and-recover, worst relative error          5   3.13e-11          0   3.13e-11  
  planted omega = 0.2 recovered from a noise-fre   5          0          0          0  
  put-call parity C-P = F-K                        5   2.84e-14          0   2.84e-14  
  quadrature of the integrated-variance moments    5   1.11e-15          0   1.11e-15  
  quadrature tolerance 1e-12 vs 1e-14              5          0          0          0  
  recursive MLE (Ljung) distance from the MLE      5     0.2287          0     0.2287  
  replay round-trip fidelity                       5          0          0          0  
  risk-neutral density mass                        5          1          0          1  
  risk-neutral density mean = forward              5          1          0          1  
  robust: steps to re-converge (and ignores the    5        1.5          0        1.5  
  rough (driver jumps): pairs with the property    5          0          0          0  
  rough jump: realised 1-day impact / its parame   5   0.005225          0   0.005225  
  rough objective evaluation, 10 expiries x 13 s   5     0.7155     0.1429     0.7904  
  rough variance simulated 3000 days: minimum      5  -1.39e-17          0  -1.39e-17  
  runaway parameters: maturities priced in-band    5          4          0          4  
  sampling density: min >= eps and mass = 1        5          0          0          0  
  scipy modules on the live import path            5          0          0          0  
  second spike: superposition identity, every ho   5   8.88e-16          0   8.88e-16  
  shipped 2nd derivative: order on a $1/$5 kink    5      3.077          0      3.077  
  simulated E[S/F] = 1                             5   1.94e-06          0   1.94e-06  
  snapshot instant recovered from the taus (loca   5          0          0          0  
  spread of kappa under 0.5vp noise                5      34.73          0      34.73  
  spread of kappa with a Tikhonov prior (weight    5    0.07281          0    0.07281  
  spread of rho under 0.5vp noise                  5       3.73          0       3.73  
  spread of theta under 0.5vp noise                5      2.803          0      2.803  
  spread of v0 under 0.5vp noise                   5      3.775   4.97e-16      3.775  
  spread of xi under 0.5vp noise                   5      19.13          0      19.13  
  stability constants enforced: the same solve r   5          1          0          1  
  stability-sized exptrap, same u range: max |ph   5     0.9988          0     0.9988  
  startup to actionable error, no TWS              5     0.7759     0.1416     0.7738  
  strict: steps to re-converge after the regime    5         18          0         18  
  tau: 17:00 Istanbul to next close, hours         5         30          0         30  
  time rescaling KS p, Hawkes fit (should pass)    5     0.5838          0     0.5838  
  time rescaling KS p, Poisson fit to the same e   5          0          0          0  
  trap / shipped separation                        5      538.9          0      538.9  
  two independent H routes agree                   5   0.002891          0   0.002891  
  unpriceable quote: minimum charge (vol) vs 0 b   5      4.754          0      4.754  
  variance cf (Riccati) vs exact affine mean and   5   5.03e-07          0   5.03e-07  
  variance time at omega = 1 vs ACT/365            5          0          0          0  
  vega vs central difference                       5   4.23e-09          0   4.23e-09  
  worst-case RMS error in H: hybrid (anchors x25   5    0.03783          0    0.03783  
  xi -> 0 degenerates to Black-Scholes             5   2.22e-16          0   2.22e-16  
  |phi(u)| <= 1                                    5     0.9999   1.24e-16     0.9999  
  0 flagged
